...
//        Map<String, Contact> book = new TreeMap<>();
        System.out.println(ProgramOptions.fromId("2"));
//       System.out.println(ProgramOptions.ADD_NEW.getId());
//        System.out.println(ProgramOptions.NUMBER_SEARCH);
//        System.out.println(ProgramOptions.NUMBER_SEARCH.getId() + " " + ProgramOptions.NUMBER_SEARCH.getDescription());
//        do {
